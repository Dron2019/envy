...
if (document.documentElement.clientWidth > 950) customCursorEffect('.catalogue-slider-js');
...
function customCursorEffect(container) {
    ...
    let msCustomCursor = `
    <svg class="custom-cursor-js" style="position:absolute; left:0;top:0; " width="178" height="187" viewBox="-20 -20 139 145" fill="none" xmlns="http://www.w3.org/2000/svg">
...
document.querySelector(catalogueItemsDropdown.childTitle).click();
