...
const scssTemplateWriter = require('./create-template');
var prettyHtml = require('gulp-pretty-html');


function performWPChange(content) {
    return content.replace(/src="\.\/assets/g, 'src="<?=get_template_directory_uri();?>/assets');
}
...
const paths = {
    ...
    templateStyles: {
        main: './src/assets/styles/template-styles',
    },
    scripts: {
...
function changePathesForWp() {
    return gulp.src(paths.templates.pages)
        .pipe(pug({ pretty: true }))
        .pipe(gulpChange(performWPChange))
        .pipe(gulp.dest(paths.templatesWp.dest));
...
exports.changePathesForWp = changePathesForWp;
